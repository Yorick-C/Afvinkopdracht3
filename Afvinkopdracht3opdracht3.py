...
main()
#Als hij de knipenzymen vind in het DNA dan zou het weergeven dat deze enzymen wel of niet kunnen knippen
#Voor enzym 1
def check():
    sequentie = getSequentie("startOpgave3.txt")
    found = False
...
check()
if True:
    print("Het enzym DdeI knipt wel")
else:
    print("Het enzym DdeI knipt niet")
#Voor enzym 2
def check():
    sequentie = getSequentie("startOpgave3.txt")
    found = False
...
check()
if True:
    print("Het enzym BspMII knipt wel")
else:
    print("Het enzym BspMII knipt niet")
#Voor enzym 3
def check():
    sequentie = getSequentie("startOpgave3.txt")
    found = False
...
check()
if True:
    print("Het enzym EcoRI knipt wel")
else:
    print("Het enzym EcoRI knipt niet")
#Voor enzym 4
def check():
    sequentie = getSequentie("startOpgave3.txt")
    found = False
...
check()
if True:
    print("Het enzym HindIII knipt wel")
else:
    print("Het enzym HindIII knipt niet")
#Voor enzym 5
def check():
    sequentie = getSequentie("startOpgave3.txt")
    found = False
...
check()
if True:
    print("Het enzym TaqI knipt wel")
else:
    print("Het enzym TaqI knipt niet")
